...
# Shortcuts label
shortcut_label = Label(text='?', font=13)
shortcut_label.place(x=304, y=76)
shortcut_label.bind('<Button-1>', f)

# Shortcuts checkbox
shortcuts_on = BooleanVar()
shortcut = Checkbutton(window, text='Shortcuts', variable=shortcuts_on, command=shortcuts_toggle)
shortcut.place(x=226, y=76)
